...
Partial Class Master_MasterPage2
    ...
    Protected Sub Page_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        ...
        '    Response.Cookies("ASP.NET_SessionId").Path = "/GNH/"
        '    Response.Cookies("ASP.NET_SessionId").Expires = DateTime.UtcNow.AddHours(5.5).AddMinutes(20)
        'End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        TreeView1.Attributes.Add("onMouseOver", "window.status=''; return true;")
        lnk_logout.Attributes.Add("onMouseOver", "window.status=''; return true;")
