...
Partial Class MASTER_Forgot_Password
    ...
    Protected Sub btn_frgtpswd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_frgtpswd.Click
        ...
        cmd.Parameters.Clear()
        If cnt0 > 0 Then
            Tell.text("Your account is locked. Please contact Geeta Nutri Heal customer care for unlocking your account", Me)
            Exit Sub
        End If
...
Err_Proc:
    ...
    Private Function SendMail(ByVal Emailids As String, ByVal pass As String, ByVal login As String) As String
        ...
        msg.Subject = "User Password Reset Geeta Nutri Heal Management"
        msg.From = "Vcare@insolutionsglobal.com"
        msg.To = Emailids
        msg.Body = "<b>" & "Dear Merchant," & "</b>" & "<br>" & "<br>"
        msg.Body = msg.Body & "Your user password for Geeta Nutri Heal Management Frontend Login have been Reset as" & "<br>" & "<br>"
        ...
        msg.Body = msg.Body & "<U>" & "<h>" & "<href>" & "https://192.168.171.38:443/GNH/master/index.aspx" & "</h>" & "</href>" & "</U>" & "<br>" & "<br>"
