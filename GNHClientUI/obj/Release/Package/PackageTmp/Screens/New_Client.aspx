<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage2.master" AutoEventWireup="true" CodeBehind="New_Client.aspx.cs" Inherits="GNHClientUI.New_Client" %>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8 control-block">
                                        ...
                                        <%--<asp:RequiredFieldValidator CssClass="err-block" ID="RequiredFieldValidator7" runat="server" ErrorMessage="Address2 Required" Display="Dynamic" ControlToValidate="txtAddress2" ValidationGroup="ValidationGroup" ForeColor="Red" Text="*"></asp:RequiredFieldValidator>--%>
                                        <%-- <asp:RequiredFieldValidator CssClass="err-block" ID="RequiredFieldValidator2" runat="server" ErrorMessage="Pin Code Required" Display="Dynamic" ControlToValidate="txtPin" ValidationGroup="ValidationGroup" ForeColor="Red" Text="*"></asp:RequiredFieldValidator>--%>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        ...
                                        <asp:RegularExpressi    onValidator CssClass="err-block err-bottom" ID="RegularExpressionValidator17" runat="server" ErrorMessage="Invalid BMI" Display="Dynamic" ControlToValidate="txtBMI" ValidationGroup="ValidationGroup" ForeColor="Red" ValidationExpression="^\d+(\.\d{1,2})?$"></asp:RegularExpressionValidator>--%>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-addon">
                                                <asp:Label ID="Label25" Text="KG" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                        <%-- <asp:RequiredFieldValidator CssClass="err-block" ID="RequiredFieldValidator2" runat="server" ErrorMessage="BMI Required" Display="Dynamic" ControlToValidate="txtBMI" ValidationGroup="validationGroup1" ForeColor="Red" Text="*"></asp:RequiredFieldValidator>--%>
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        <div class="input-group">
                                            <asp:TextBox CssClass="form-control" ID="txtWeightGainLossMonth" runat="server" TabIndex="15" autocomplete="off" ToolTip="+ for Gain and - for Loss"></asp:TextBox>
                                            <div class="input-group-addon">
                                                <asp:DropDownList CssClass="form-control" ID="ddlWeightUnit5" runat="server" TabIndex="16">
                                                    <asp:ListItem Value="KG">Kg</asp:ListItem>
                                                    <asp:ListItem Value="LBS">Lbs</asp:ListItem>
                                                    <asp:ListItem Value="GRAM">Gram</asp:ListItem>
                                                </asp:DropDownList>
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        <div class="input-group">
                                            <asp:TextBox CssClass="form-control" ID="txtWeightGainLossSixMonth" runat="server" TabIndex="17" autocomplete="off" ToolTip="+ for Gain and - for Loss"></asp:TextBox>
                                            <div class="input-group-addon">
                                                <asp:DropDownList CssClass="form-control" ID="ddlWeightUnit6" runat="server" TabIndex="18">
                                                    <asp:ListItem Value="KG">Kg</asp:ListItem>
                                                    <asp:ListItem Value="LBS">Lbs</asp:ListItem>
                                                    <asp:ListItem Value="GRAM">Gram</asp:ListItem>
                                                </asp:DropDownList>
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        <div class="input-group">
                                            <asp:TextBox CssClass="form-control" ID="txtweightGainLossYear" runat="server" TabIndex="19" autocomplete="off" ToolTip="+ for Gain and - for Loss"></asp:TextBox>
                                            <div class="input-group-addon">
                                                <asp:DropDownList CssClass="form-control" ID="ddlWeightUnit7" runat="server" TabIndex="20">
                                                    <asp:ListItem Value="KG">Kg</asp:ListItem>
                                                    <asp:ListItem Value="LBS">Lbs</asp:ListItem>
                                                    <asp:ListItem Value="GRAM">Gram</asp:ListItem>
                                                </asp:DropDownList>
                                ...
                                <div class="form-group col-sm-6 col-md-12">
                                    ...
                                    <div class="col-sm-10  control-block">
                                        <asp:TextBox CssClass="form-control" ID="txtReason" runat="server" TextMode="MultiLine" Width="100%" TabIndex="21" autocomplete="off"></asp:TextBox>
                                ...
                                <div class="form-group col-sm-6 col-md-12">
                                    <label class="col-sm-1 control-label text-right">Notes</label>
                                    <div class="col-sm-11  control-block">
                                        <asp:TextBox CssClass="form-control" ID="txtNotes2" runat="server" TextMode="MultiLine" Width="100%" TabIndex="22" autocomplete="off"></asp:TextBox>
                                        <%--<asp:RequiredFieldValidator CssClass="err-block" ID="RequiredFieldValidator27" runat="server" ErrorMessage="Antropometrics Notes Required" Display="Dynamic" ControlToValidate="txtNotes2" ValidationGroup="ValidationGroup" ForeColor="Red" Text="*"></asp:RequiredFieldValidator>--%>
                        ...
                        <div id="tabs-4" class="tab-pane fade">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        <asp:DropDownList CssClass="form-control" runat="server" ID="ddlAsthma" TabIndex="3">
                                            <asp:ListItem>No</asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        <asp:DropDownList CssClass="form-control" runat="server" ID="ddlSleepApnea" TabIndex="4">
                                            <asp:ListItem>No</asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        <asp:DropDownList CssClass="form-control" runat="server" ID="ddlThyroid" TabIndex="5">
                                            <asp:ListItem>Yes</asp:ListItem>
                                            <asp:ListItem>No</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                ...
                                <div class="form-group col-sm-6 col-md-4 NoThyroid">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        <asp:DropDownList CssClass="form-control" runat="server" ID="ddlThyroidType" TabIndex="6">
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        ...
                                        <asp:DropDownList CssClass="form-control" runat="server" ID="ddlIhd" TabIndex="8">
                                            <asp:ListItem>No</asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                ...
                                <div class="form-group col-sm-6 col-md-4">
                                    ...
                                    <div class="col-sm-8  control-block">
                                        <asp:DropDownList CssClass="form-control" runat="server" ID="ddlFunctionslStatus" TabIndex="9">
                                ...
                                <div class="form-group col-sm-6 col-md-12">
                                    <label class="col-sm-1 control-label text-right">Notes</label>
                                    <div class="col-sm-11  control-block">
                                        <asp:TextBox CssClass="form-control" ID="txtNotes4" runat="server" TextMode="MultiLine" Width="100%" TabIndex="11" autocomplete="off"></asp:TextBox>
                                        <%--<asp:RequiredFieldValidator CssClass="err-block" ID="RequiredFieldValidator43" runat="server" ErrorMessage="Comorbidity Notes  Required" Display="Dynamic" ControlToValidate="txtNotes4" ValidationGroup="ValidationGroup" ForeColor="Red" Text="*"></asp:RequiredFieldValidator>--%>
