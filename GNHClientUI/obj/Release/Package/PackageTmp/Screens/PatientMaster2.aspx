<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage2.master" AutoEventWireup="true" CodeBehind="PatientMaster2.aspx.cs" Inherits="GNHClientUI.PatientMaster2" %>
...
function IBW() {
    ...
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            ...
            <asp:TextBox CssClass="form-control" Width="10%" Style="cursor: auto !important; display: inline" ID="AppDate" runat="server" autocomplete="off" PlaceHolder="dd/MM/yyyy"></asp:TextBox>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-md-12 padd">
                                    ...
                                    <div class="col-sm-2 control-block align-center">
                                        <asp:Button runat="server" ID="btnClientData" Text="Save" CssClass="btn btn-primary btn-lg btn-block display" CausesValidation="true" ValidationGroup="ValidationGroup" OnClick="btnClientData_Click" Visible="false" />
                                    </div>
                                </div>
                                <div class="form-group col-sm-6 col-md-12 padd">
                        ...
                        <div id="tabs-2" class="tab-pane fade">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-md-12 padd">
                                    <div class="col-sm-5 control-block align-center"></div>
                                    <div class="col-sm-2 control-block align-center">
                                        <asp:Button runat="server" ID="btnAnthro" Text="Save" CssClass="btn btn-primary btn-lg btn-block display" CausesValidation="true" ValidationGroup="validationGroup1" OnClick="btnAnthro_Click" Visible="false" />
                                    </div>
                                </div>
                                <div class="form-group col-sm-6 col-md-12 padd">
                                    <div class="col-sm-12 control-block">
                        ...
                        <div id="tabs-3" class="tab-pane fade">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-md-12 padd">
                                    <div class="col-sm-5 control-block align-center"></div>
                                    <div class="col-sm-2 control-block align-center">
                                        <asp:Button runat="server" ID="btnBio" Text="Save" CssClass="btn btn-primary btn-lg btn-block display" CausesValidation="true" ValidationGroup="validationGroup2" OnClick="btnBio_Click" Visible="false" />
                                    </div>
                                </div>
                                <div class="form-group col-sm-6 col-md-12 padd">
                                    <div class="col-sm-12 control-block">
                        ...
                        <div id="tabs-5" class="tab-pane fade">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-md-12 padd">
                                    <div class="col-sm-5 control-block align-center"></div>
                                    <div class="col-sm-2 control-block align-center">
                                        <asp:Button runat="server" ID="btnDietLifestyle" Text="Save" CssClass="btn btn-primary btn-lg btn-block display" CausesValidation="true" ValidationGroup="validationGroup4" OnClick="btnDietLifestyle_Click" Visible="false" />
                                    </div>
                                </div>
                                <div class="form-group col-sm-6 col-md-12 padd">
                                    <div class="col-sm-12 control-block">
