<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="GNHClientUI.WebForm4" %>
        ...
        <div class="panel-group" id="accordion">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <!-- title 2 -->
                        <a data-toggle="collapse" data-parent="#accordion" href="#accordionTwo">Collapsible Accordion 2
                        </a>
                    </h4>
                </div>
                <!-- panel body -->
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <!-- title 3 -->
                        <a data-toggle="collapse" data-parent="#accordion" href="#accordionThree">Collapsible Accordion 3
                        </a>
                    </h4>
                </div>
