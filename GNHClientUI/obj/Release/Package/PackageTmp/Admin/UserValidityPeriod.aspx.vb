...
#Region " Web Form Designer Generated Code "
    ...
    Protected Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Error
        ...
        acs.WriteError(sLastError, sStackTrace, sUser, PhyFilePath, "GNH-User Validity")
    End Sub
...
#End Region
    ...
    Dim path As String = System.IO.Directory.GetDirectoryRoot(AppDomain.CurrentDomain.BaseDirectory) & "GNHReports\ADMIN\UserSessionTrack_REPORT\"
    ...
    Private Sub generateExcel(ByVal ds As DataSet)
        filename = "UserSessionTrack" & Format(DateTime.UtcNow.AddHours(5.5), "MMMdd")
    ...
    Protected Sub Btn_Save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btn_Save.Click
        ...
        Dim strinst As String = "INSERT INTO ADMIN_MAPS_USER_ACTION_TRAIL(USER_NAME, UPDATED_BY, ACTION, ACTION_DATE) VALUES(@USER_NAME,'" + Session("UserCode") + "','USERS VALIDITIY EXTENDED',dateadd(minute,330,getutcdate()))"
