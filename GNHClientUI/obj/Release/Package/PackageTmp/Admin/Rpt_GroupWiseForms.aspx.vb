...
Public Class admin_Rpt_GroupWiseForms
    ...
    Dim path As String = System.IO.Directory.GetDirectoryRoot(AppDomain.CurrentDomain.BaseDirectory) & "GNHReports\ADMIN\Rpt_GroupWise_Forms\"
...
#End Region
    ...
    Private Sub generateExcel(ByVal ds As DataSet)
        filename = "Rpt_GroupWise_Forms" & Format(DateTime.UtcNow.AddHours(5.5), "MMMdd")
    ...
    Private Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Error
        ...
        objHelperClass.WriteError(sLastError, sStackTrace, sUser, PhyFilePath, "GNH Groupwise")
    End Sub
End Class
'***********************************************************************************************************************
