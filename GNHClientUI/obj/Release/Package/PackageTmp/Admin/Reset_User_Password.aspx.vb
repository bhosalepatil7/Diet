...
#End Region
    ...
    Private Sub LinkButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LinkButton1.Click
        ...
        If TextBox2.Text = TextBox1.Text Then
            ...
            Dim cmd As New SqlCommand("update ADMIN_MAPS_user_master set USER_PASSWORD = @newPassword , PASSWORD_DATE=dateadd(minute,330,getutcdate())  where UPPER(USER_NAME)= UPPER(@userCode) ", conn)
    ...
    Private Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Error
        ...
        acs.WriteError(sLastError, sStackTrace, sUser, PhyFilePath, "GNH Reset User Password")
    End Sub
End Class
'***********************************************************************************************************************
