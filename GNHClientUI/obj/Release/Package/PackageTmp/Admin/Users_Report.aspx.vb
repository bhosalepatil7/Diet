...
#End Region
    ...
    Dim path As String = System.IO.Directory.GetDirectoryRoot(AppDomain.CurrentDomain.BaseDirectory) & "GNHReports\ADMIN\ADMIN_Report\"
    ...
    Private Sub generateExcel(ByVal ds As DataSet)
        filename = "ADMIN" & Format(DateTime.UtcNow.AddHours(5.5), "MMMdd")
    ...
    Private Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Error
        ...
        acs.WriteError(sLastError, sStackTrace, sUser, PhyFilePath, "Geeta Nutri Heal-User Report")
    End Sub
End Class
