<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage2.master" AutoEventWireup="true" CodeBehind="DietPlan.aspx.cs" Inherits="GNHClientUI.Screens.DietPlan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <div class="form-inline">
                        ...
                        <label class="inline">
                            <span>&nbsp;&nbsp;&nbsp;</span>
                            <input type="checkbox" class="ace" id="chk48DietRecall" onchange="setDietRecallType()" />
    ...
    <script>
        ...
        function addFoodRow(MealId) {
            ...
            $.ajax({
                type: "POST",
                url: "../Screens/DietPlan.aspx/GetFoodNutrients",
        ...
        function saveMeal(MealId) {
            ...
            $.ajax({
                type: "POST",
                url: "../Screens/DietPlan.aspx/SaveSingleMealDetails",
