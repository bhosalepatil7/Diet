<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage2.master" AutoEventWireup="true" CodeBehind="Client_Details.aspx.cs" Inherits="GNHClientUI.Client_Details" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" ChildrenAsTriggers="true" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            ...
            <div style="width: 98%; align-content: center; padding-top: 10px">
                <asp:GridView ID="grdPatients" runat="server" CssClass="table table-bordered table-striped dataTable" OnPageIndexChanging="grdPatients_PageIndexChanging"
                    OnRowCommand="on_row" AutoGenerateColumns="False" PageSize="10" AllowPaging="false" OnRowDataBound="grdPatients_RowDataBound" ShowHeaderWhenEmpty="true" EmptyDataText="No Records Found..">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Client Name">
                            <ItemTemplate>
                                ...
                                <%--<asp:Label ID="lblName" Text='<%#Eval("PatientName") +" "+ Eval("MiddleName")+" "+Eval("LastName")  %>' runat="server"></asp:Label>--%>
                            </ItemTemplate>
                        </asp:TemplateField>
