            ...
            <table style="width: 100%">
                <tr>
                    <td rowspan="2">
                        ...
                        <img src="../../Images/Logo.jpg" style="height: 76px; left: 30%; text-align: left" />
                    </td>
                    <td>
                        <%--<span id='lbl' style='color:Lime;font-family:Calibri;font-size:XX-Large;font-weight:bold;'>Right Nutrition for Health</span>--%>
                        <span id='lbl' style='color: #0b6b3b; font-family: Calibri; font-size: 23px; font-size: x-large; /* font-weight: bold; */'><i>Right Nutrition for Health</i></span>
                    </td>
                </tr>
                <tr>
                </tr>
