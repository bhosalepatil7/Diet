...
Public Class admin_User_Status_report
    ...
    Dim path As String = System.IO.Directory.GetDirectoryRoot(AppDomain.CurrentDomain.BaseDirectory) & "GNHReports\ADMIN\UserStatusReport\"
...
#End Region
    ...
    Private Sub generateExcel(ByVal ds As DataSet)
        filename = "UserStatusReport" & Format(DateTime.UtcNow.AddHours(5.5), "MMMdd")
    ...
    Private Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Error
        ...
        acs.WriteError(sLastError, sStackTrace, sUser, PhyFilePath, "GNH-User Status")
    End Sub
