...
Public Class admin_Rpt_UserWiseScreen
    ...
    Dim path As String = System.IO.Directory.GetDirectoryRoot(AppDomain.CurrentDomain.BaseDirectory) & "GNHReports\ADMIN\Rpt_UserWise_Forms\"
...
#End Region
    ...
    Private Sub generateExcel(ByVal ds As DataSet)
        filename = "Rpt_UserWise_Forms" & Format(DateTime.UtcNow.AddHours(5.5), "MMMdd")
    ...
    Private Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Error
        ...
        acs.WriteError(sLastError, sStackTrace, sUser, PhyFilePath, "GNH UserwiseScreen")
    End Sub
