...
#End Region
    ...
    Protected Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Error
        ...
        acs.WriteError(sLastError, sStackTrace, sUser, PhyFilePath, "GNH Assign Rights to User")
    End Sub
        ...
        For Each GvRow In DataGrid2.Rows
            ...
            If ChkBoxGroup.Checked = True Then
                ...
                ElseIf ChkUsrGrpFlag = "0" And ChkFlag = "0" Then            ' User Id and Group Id are =====>  NOT PRESENT  <======= in Admin_Maps_Group_User_Master
                    ...
                    cmdInsert = New SqlCommand("Insert Into ADMIN_MAPS_GRP_USR_MSTR_TEMP(User_ID, Group_ID, Status, Maker_Date , Maker_Name, REMARK ) values (@UserID, @GroupID, 'Pending', dateadd(minute,330,getutcdate()) , @MakerName , 'ADD')", conn)
            ...
            ElseIf ChkBoxGroup.Checked = False Then
                ...
                If ChkUsrGrpFlag = "1" And ChkFlag = "0" Then               ' User Id and Group Id are =====> NOT  PRESENT  <======= in Admin_Maps_Group_User_Master
                    ...
                    cmdInsert = New SqlCommand("Insert Into ADMIN_MAPS_GRP_USR_MSTR_TEMP(User_ID, Group_ID, Status, Maker_Date , Maker_Name, REMARK ) values (@UserID, @GroupID, 'Pending', dateadd(minute,330,getutcdate()) , @MakerName , 'DELETE')", conn)
                    prmMakerName.Value = Session("UserCode")
                    cmdInsert.Parameters.Add(prmUserId)
                    cmdInsert.Parameters.Add(prmGroupId)
                    cmdInsert.Parameters.Add(prmMakerName)
