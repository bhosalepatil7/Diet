...
#End Region
    ...
    Private Sub lnkAuthNewEnrol_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lnkAuthNewEnrol.Click
        Dim cmdUpd As New SqlCommand("update ADMIN_MAPS_USER_MASTER  SET   ACCOUNT_STATUS=@BLOCKED  ,UPDATED_BY=@UPDATED_BY,STATUS_DATE=dateadd(minute,330,getutcdate()) where USER_NAME=@USER_NAME", conn)
    ...
    Private Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Error
        ...
        acs.WriteError(sLastError, sStackTrace, sUser, PhyFilePath, "GNH-User Unlocking")
    End Sub
End Class
'***********************************************************************************************************************
