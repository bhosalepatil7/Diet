...
Public Class admin_User_Action_Trial
    ...
    Dim path As String = System.IO.Directory.GetDirectoryRoot(AppDomain.CurrentDomain.BaseDirectory) & "GNHReports\ADMIN\UserActionTrail_REPORT\"
...
#End Region
    ...
    Private Sub generateExcel(ByVal ds As DataSet)
        filename = "UserActionTrail" & Format(DateTime.UtcNow.AddHours(5.5), "MMMdd")
    ...
    Private Sub Page_Error(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Error
        ...
        acs.WriteError(sLastError, sStackTrace, sUser, PhyFilePath, "GNH User Action Trail")
    End Sub
End Class
'***********************************************************************************************************************
