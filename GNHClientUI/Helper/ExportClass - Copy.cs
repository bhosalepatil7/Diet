...
namespace GNHClientUI.Helper
{
    public class ExportClass
    {
        ...
        //    //Client Info
        //    strBody.Append(" <table align='center' width='100%'><tr><td align='left'>Geeta Nutri Heal Center</td><td></td><td colspan=2 align='right'>Date - " + DateTime.UtcNow.AddHours(5.5).ToShortDateString() + "</td>");
        //    strBody.Append("<tr><td align='left'>Geeta Nutri Heal Center Address Line</td><td></td><td colspan=2 align='right'>Time - " + DateTime.UtcNow.AddHours(5.5).ToShortTimeString() + "</td></tr>");
        ...
        //    strBody.Append("<table align='center' width='100%' cellpading='1px'><tr><td align='left'>" + objDietMaster.CustomerName + " " + objDietMaster.LastName + "</td><td align='center'>Patient ID :" + objDietMaster.CustomerID + "</td><td colspan='2' align='right'>" + DateTime.UtcNow.AddHours(5.5).ToShortDateString() + " " + DateTime.UtcNow.AddHours(5.5).ToShortTimeString() + "</td></tr>");
        //    strBody.Append("<tr><td colspan='4' align='center'>&copy;&nbsp; " + DateTime.UtcNow.AddHours(5.5).Year + " Geeta Neutri Heals</td></tr></table>");
        ...
        //    strBody.Append("<tr><td colspan=4 align='left'>BMI :" + objDietMaster.CalculatedBMI + " </td></tr>");
        //    strBody.Append("<tr><td colspan=4 align='left'>Waist Circumference :" + objDietMaster.MeasuredWaist * 100 + " Cm</td></tr>");
        ...
        //    strBody.Append("<table border='1' width=90% style='border-collapse: collapse;' bordercolor='black'><tr><td align='right'><b>Biochemical Item</b></td><td align='right'><b>Value</b></td><td align='right'><b>Unit</b></td>");
        //    strBody.Append("<td align='left'><b>Biochemical Item</b></td><td align='left'><b>Value</b></td><td align='left'><b>Unit</b></td></tr>");
        //    strBody.Append("<tr><td align='left'>Fasting Glucose</td><td align='left'>" + (objDietMaster.FastingGlucose.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.FastingGlucose)) + "</td><td align='left'>mg/dL</td>");
        //    strBody.Append("<td align='right'>Creatinine</td><td align='right'>" + (objDietMaster.Creatinine.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.Creatinine)) + "</td><td align='right'>g/dL</td></tr>");
        //    strBody.Append("<tr><td align='left'>Albumin</td><td align='left'>" + (objDietMaster.Albumin.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.Albumin)) + "</td><td align='left'>g/dL</td>");
        //    strBody.Append("<td align='right'>HbA1C</td><td align='right'>" + (objDietMaster.HbA1C.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.HbA1C)) + "</td><td align='right'>%</td></tr>");
        //    strBody.Append("<tr><td align='left'>ALT (SGPT)</td><td align='left'>" + (objDietMaster.AltSGPT.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.AltSGPT)) + "</td><td align='left'>IU/L</td>");
        //    strBody.Append("<td align='right'>ALT (SGOT)</td><td align='right'>" + (objDietMaster.AltSGOT.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.AltSGOT)) + "</td></td><td align='right'>IU/L</td></tr>");
        //    strBody.Append("<tr><td align='left'>Hematocrit</td><td align='left'>" + (objDietMaster.Hematocrit.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.Hematocrit)) + "</td><td align='left'>(%)</td>");
        //    strBody.Append("<td align='right'>Triglycerides</td><td align='right'>" + (objDietMaster.Triglycerides.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.Triglycerides)) + "</td><td align='right'>mg/dL</td></tr>");
        //    strBody.Append("<tr><td align='left'>HDL</td><td align='left'>" + (objDietMaster.HDL.ToString().ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.HDL)) + "</td><td align='left'>mg/dL</td>");
        //    strBody.Append("<td align='right'>Total Cholesterol</td><td align='right'>" + (objDietMaster.TotalCholesterol.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.TotalCholesterol)) + "</td><td align='right'>mg/dL</td></tr>");
        //    strBody.Append("<tr><td align='left'>Alkaline Phosphatase</td><td align='left'>" + (objDietMaster.AlkalinePhosphatase.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.AlkalinePhosphatase)) + "</td><td align='left'>IU/L</td>");
        //    strBody.Append("<td align='right'>Vitamin D3</td><td align='right'>" + (objDietMaster.VitaminD3.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.VitaminD3)) + "</td><td align='right'></td></tr>");
        //    strBody.Append("<tr><td align='left'>Vitamin B12</td><td align='left'>" + (objDietMaster.VitaminB12.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.VitaminB12)) + "</td><td align='left'></td>");
        //    strBody.Append("<td align='right'>Others</td><td align='right'>" + (objDietMaster.OthersBioChemicalLabs.ToString().Equals("-1") ? "Normal" : Convert.ToString(objDietMaster.OthersBioChemicalLabs)) + "</td><td align='right'></td></tr></table></li>");

        //    //Comorbidity
        //    strBody.Append("<li>Comorbidity");
        //    strBody.Append("<table width=90% border='1' style='border-collapse: collapse;' bordercolor='black'>");
        //    strBody.Append("<tr><td align='left'>Regular Execise</td><td align='left'>" + objDietMaster.RegularExcercise + "</td><td align='right'>Alcohol</td><td align='right'>" + objDietMaster.Alcohol + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>Smoking</td><td align='left'>" + objDietMaster.Smoking + "</td><td align='right'>Sleep Hours Per Day</td><td align='right'>" + objDietMaster.SleepHoursPerDay + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>Diet Type</td><td align='left'>" + objDietMaster.DietType + "</td><td align='right'>Eat When Stress</td><td align='right'>" + objDietMaster.EatWhenStressed + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>Frequency Of Outside Eat</td><td align='left'>" + objDietMaster.FreqOutFoodEat + "</td><td align='right'>Eat When Bored</td><td align='right'>" + objDietMaster.EatWhenBored + "</td></tr>");
        ...
        //    strBody.Append("<tr><td align='left'>Caloric Beverages</td><td align='left'>" + objDietMaster.Caloricbeverages + "</td><td align='right'>Tried Wt. Loss Diet Before</td><td align='right'>" + objDietMaster.TriedWeightLossDiet + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>Oil Detail</td><td align='left'>" + objDietMaster.OilUseDetail + "</td><td align='right'>Oil Quantity in Month</td><td align='right'>" + objDietMaster.OilQuantityForMonth + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>No of Family Members</td><td align='left'>" + objDietMaster.NoOfMembersInFamily + "</td><td align='right'>Sugar Quantity in Month</td><td align='right'>" + objDietMaster.SugarQuantityForMonth + "</td></tr></table></li>");


        //    //Clinical Complaints
        //    strBody.Append("<li>Clinical Complaints</li>");
        //    strBody.Append("<table width=90% border='1' style='border-collapse: collapse;' bordercolor='black'>");
        //    strBody.Append("<tr><td align='left'>Heartburn </td><td align='right'>" + objDietMaster.Heartburn + "</td><td align='right'>Vomiting</td><td align='right'>" + objDietMaster.Vomiting + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>Bloating</td><td align='right'>" + objDietMaster.Bloating + "</td><td align='right'>Use Any Luxative/Antacid</td><td align='right'>" + objDietMaster.LaxativeAntacide + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>Gas</td><td align='right'>" + objDietMaster.Gas + "</td><td align='right'>Constipation</td><td align='right'>" + objDietMaster.Constipation + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>Diarrhoea</td><td align='right'>" + objDietMaster.Diarrhoea + "</td><td align='right'>Follow Home Remedy</td><td align='right'>" + objDietMaster.HomeRemedy + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>Vitamin Suplement </td><td align='right'>" + objDietMaster.TakeVitaminSup + "</td><td align='right'>Vitamin Suplement Details</td> <td align='right'>" + objDietMaster.VitaminSupDet + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>Mineral Suplement </td><td align='right'>" + objDietMaster.TakeMineralSup + "</td><td align='right'>Mineral Suplement Details </td><td align='left'>" + objDietMaster.MineralSupDet + "</td></tr>");
        //    strBody.Append("<tr><td align='left'>Oral Drug Type </td><td align='right'>" + objDietMaster.OralDrugDType + "</td><td align='right'>Oral Drug  Details </td><td align='right'>" + objDietMaster.OralDrugDet + "</td></tr></table>");

        //    strBody.Append("</ol></td></tr></table>");
        //    strBody.Append("<table width=100%><tr><td>Diet Type:</td></tr><tr><td>" + objDietMaster.DietType + "</td></tr>");
        //    strBody.Append("<tr><td>Exercise Details:</td></tr><tr><td>" + objDietMaster.ExcersizeDetail + "</td></tr>");
        //    strBody.Append("<tr><td><b>Medical Nutrition Therapy</b></td></tr><tr><td><ol><li>Calorie Management:&nbsp;CALORIE_TOTAL</li><li>Protein Management:&nbsp;PROTEIN_TOTAL</li>");
        ...
        //    strBody.Append("<table width=90%><tr><td><b>Recommended Diet:</b></td></tr></table>");
        ...
        //    strBody.Append("Here is sample menu options to help you understand your diet.</td></tr></table><br/><br/>");
        //    strBody.Append("<table border=1 width=90% style='border-collapse: collapse;' bordercolor='black'><tr><td align=center><b>Meals/Snacks</b></td><td align=center><b>Diet Plan A</b></td></tr>");
