...
public class HelperClass
{
    ...
    public string Default_Page(string rp)
    {
        ...
        //str_ret = "~/Screens/PatientDetails.aspx";
        return str_ret;
    }
    ...
    public void WriteError(string sLastError, string sStackTrace, string sUser, string path, string sAppName, string s_Event_id = "")
    {
        ...
        //sw.WriteLine("---------------------------------------------------------------------------------------------------------------------");
        //sw.WriteLine(("Date: " + DateTime.UtcNow.AddHours(5.5)));
        ...
        //sw.WriteLine(("Application Name: " + "Geeta Nutri Heal Management :"+sAppName));
    ...
    public string ValidateDate(string str_Date, string d_Type)
    {
        ...
        //    Exit Function
        //End If
        if (Convert.ToDateTime(str_Date) > DateTime.UtcNow.AddHours(5.5))
        {
    ...
    public string ValidateFromDateToDate(string str_FromDate, string str_ToDate)
    {
        ...
        if (Convert.ToDateTime(str_FromDate) > DateTime.UtcNow.AddHours(5.5))
        {
        ...
        //    Exit Function
        //End If
        if (Convert.ToDateTime(str_ToDate) > DateTime.UtcNow.AddHours(5.5))
        {
    ...
    public void writeLogDB(string sUser, string filename, string rptname)
    {
        ...
        SqlCommand Log = new SqlCommand("insert into admin_report_log values(@sUser,@fname,@rptName,dateadd(minute,330,getutcdate()))", conn);
