<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RecallDiet.ascx.cs" Inherits="GNHClientUI.UserControls.RecallDiet" %>
...
<style>
    ...
    #diet-table, #diet-table-Meal1, #diet-table-Meal2, #diet-table-Meal3, #diet-table-Meal4, #diet-table-Meal4, #diet-table-Meal5, #diet-table-Meal6, #diet-table-Meal7, #diet-table-Meal8, #diet-table-Meal9, #diet-table-Meal10, #diet-table-Meal11, #diet-table-Meal12 {
        width: 100%;
    }
...
<div class="page-header">
    <div class="widget-box">
        <div class="widget-header">
            <h4 class="widget-title">Recall Diet</h4>
        </div>
        ...
        <div class="widget-body hidden">
            <div class="widget-main">
                <div class="form-inline">
                    ...
                    <label class="inline">
                        <span>&nbsp;&nbsp;&nbsp;</span>
                        <input type="checkbox" class="ace" id="chk48DietRecall" onchange="setDietRecallType()" checked="checked" />
    ...
    <div class="col-xs-12" style="overflow: auto;">
        ...
        <div class="form-horizontal" id="dietplan-form" role="form">
            ...
            <div class="form-group">
                <table class="table table-bordered table-striped" id="tblRecallFoodListTotal">
                    <tbody>
                        <tr>
                            <th></th>
                            <th>Energy (kcal)</th>
            ...
            <div id="divRecallDietMeals" runat="server">
                <%--<div class="form-group">
